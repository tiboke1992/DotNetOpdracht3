...
namespace ASPNetBoekenApplicatie
{
	...
	public partial class Boekenlijst : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<SchoolartikelBoekenlijst> _SchoolartikelBoekenlijsts;
    ...
    partial void OnaantalLeerlingenChanged();
		...
		{
			this._BoekBoekenlijsts = new EntitySet<BoekBoekenlijst>(new Action<BoekBoekenlijst>(this.attach_BoekBoekenlijsts), new Action<BoekBoekenlijst>(this.detach_BoekBoekenlijsts));
			this._SchoolartikelBoekenlijsts = new EntitySet<SchoolartikelBoekenlijst>(new Action<SchoolartikelBoekenlijst>(this.attach_SchoolartikelBoekenlijsts), new Action<SchoolartikelBoekenlijst>(this.detach_SchoolartikelBoekenlijsts));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Boekenlijst_SchoolartikelBoekenlijst", Storage="_SchoolartikelBoekenlijsts", ThisKey="klas", OtherKey="klas")]
		public EntitySet<SchoolartikelBoekenlijst> SchoolartikelBoekenlijsts
		{
			get
			{
				return this._SchoolartikelBoekenlijsts;
			}
			set
			{
				this._SchoolartikelBoekenlijsts.Assign(value);
			}
		}
    ...
    partial void OnprijsChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Schoolartikel_SchoolartikelBoekenlijst", Storage="_SchoolartikelBoekenlijsts", ThisKey="id", OtherKey="id_schoolartikel")]
		public EntitySet<SchoolartikelBoekenlijst> SchoolartikelBoekenlijsts
		{
			get
			{
	...
	public partial class SchoolartikelBoekenlijst : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Schoolartikel> _Schoolartikel;
    ...
    partial void OnklasChanging(string value);
    partial void OnklasChanged();
    partial void Onid_schoolartikelChanging(int value);
    partial void Onid_schoolartikelChanged();
    ...
    partial void OnprijsChanged();
		...
		{
			this._Boekenlijst = default(EntityRef<Boekenlijst>);
			this._Schoolartikel = default(EntityRef<Schoolartikel>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_id_schoolartikel", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int id_schoolartikel
		{
			...
			set
			{
				...
				{
					if (this._Schoolartikel.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.Onid_schoolartikelChanging(value);
					this.SendPropertyChanging();
					this._id_schoolartikel = value;
					this.SendPropertyChanged("id_schoolartikel");
					this.Onid_schoolartikelChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Boekenlijst_SchoolartikelBoekenlijst", Storage="_Boekenlijst", ThisKey="klas", OtherKey="klas", IsForeignKey=true)]
		public Boekenlijst Boekenlijst
		{
			get
			{
			...
			set
			{
							...
							|| (this._Boekenlijst.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Boekenlijst.Entity = null;
						previousValue.SchoolartikelBoekenlijsts.Remove(this);
					}
					this._Boekenlijst.Entity = value;
					if ((value != null))
					{
						value.SchoolartikelBoekenlijsts.Add(this);
						this._klas = value.klas;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Schoolartikel_SchoolartikelBoekenlijst", Storage="_Schoolartikel", ThisKey="id_schoolartikel", OtherKey="id", IsForeignKey=true)]
		public Schoolartikel Schoolartikel
		{
			get
			{
				return this._Schoolartikel.Entity;
			}
			set
			{
				Schoolartikel previousValue = this._Schoolartikel.Entity;
				if (((previousValue != value) 
							|| (this._Schoolartikel.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Schoolartikel.Entity = null;
						previousValue.SchoolartikelBoekenlijsts.Remove(this);
					}
					this._Schoolartikel.Entity = value;
					if ((value != null))
					{
						value.SchoolartikelBoekenlijsts.Add(this);
						this._id_schoolartikel = value.id;
					}
					else
					{
						this._id_schoolartikel = default(int);
					}
					this.SendPropertyChanged("Schoolartikel");
				}
			}
		}
